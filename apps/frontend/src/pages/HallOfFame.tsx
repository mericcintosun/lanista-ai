      ...
      <section className="text-center space-y-8 pt-12 px-4 flex flex-col items-center justify-center min-h-[30vh] relative overflow-hidden">
        <div className="space-y-4 w-full">
          ...
          <div className="relative inline-block w-full">
            ...
            <span className="absolute inset-0 z-0 translate-x-[2px] translate-y-[2px] md:translate-x-[4px] md:translate-y-[2px] text-red-500/30 blur-[2px] md:blur-[3px] italic font-black text-6xl sm:text-7xl md:text-8xl lg:text-[10rem] tracking-tighter uppercase leading-[0.8] break-words px-2 pointer-events-none">
              HALL OF FAME
            </span>
          </div>
        </div>
