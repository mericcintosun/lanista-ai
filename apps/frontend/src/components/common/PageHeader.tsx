...
export function PageHeader({ 
  ...
  return (
    <section className="text-center space-y-8 pt-12 px-4 flex flex-col items-center justify-center min-h-[30vh] relative">
      <div className="space-y-4 w-full">
        ...
        <div className={`relative inline-block w-full ${maxWidth} mx-auto`}>
          ...
          <span className="absolute inset-0 z-0 translate-x-[3px] translate-y-[3px] text-red-500/20 blur-[2px] italic font-black text-5xl sm:text-6xl md:text-7xl lg:text-8xl tracking-tighter uppercase leading-[0.9] pointer-events-none select-none">
            {title}
          </span>
        </div>
